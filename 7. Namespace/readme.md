...
2️⃣ Deploy Nginx inside `dev-team` namespace
3️⃣ Deploy Redis inside `staging-team` namespace
4️⃣ Verify using:
...
5️⃣ (Bonus) Set ResourceQuota for `dev-team` namespace

---

## 🔮 Next Lesson Preview

👉 **Lesson 11: ConfigMap & Secret in Kubernetes**
Learn how to store app configuration and passwords securely 🔐

---

Would you like me to start **Lesson 11: ConfigMap & Secret** now?
